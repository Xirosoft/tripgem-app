    ...
    async initializeData() {
      ...
      try {
        ...
        this.userData.meta.language =
          ...
          this.userData.meta.language.trim().startsWith('[') &&
          this.userData.meta.language.trim().endsWith(']')
        ...
        this.userData.meta.social_links =
          ...
          this.userData.meta.social_links.trim().startsWith('{') &&
          this.userData.meta.social_links.trim().endsWith('}')
