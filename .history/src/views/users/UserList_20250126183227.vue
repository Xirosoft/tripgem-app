            ...
            defaultContent: `
              <div class="d-inline-block">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item edit-user" href="javascript:void(0);"><i class="ti ti-pencil me-1"></i>Edit</a>
                  <a class="dropdown-item view-user" href="javascript:void(0);"><i class="ti ti-eye me-1"></i>View</a>
                  <a class="dropdown-item text-danger delete-user" href="javascript:void(0);"><i class="ti ti-trash me-1"></i>Delete</a>
                </div>
              </div>
            `,
          },
