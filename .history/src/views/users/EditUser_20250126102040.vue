...
export default {
  ...
  methods: {
    ...
    async onParentRoleChange() {
      this.usersListStore.filterUserRoles(this.userData.parent_role_id)
      this.filteredUserRoles = this.usersListStore.getFilteredUserRoles
    ...
    async onRoleChange() {
      if (['19', '6', '16', '12'].includes(this.userData.parent_role_id)) {
        await this.usersListStore.fetchCompanies(this.userData.parent_role_id)
