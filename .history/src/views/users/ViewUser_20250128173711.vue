          ...
          <div class="flex-grow-1 mt-3 mt-lg-5">
            ...
            >
              ...
              <div class="social_links">
                <a
                  v-if="socialLinksfacebook_link"
                  :href="socialLinksfacebook_link"
                  target="_blank"
                ...
                <a
                  v-if="socialLinkstwitter_link"
                  :href="socialLinkstwitter_link"
                  target="_blank"
                ...
                <a
                  v-if="socialLinkslinkedin_link"
                  :href="socialLinkslinkedin_link"
                  target="_blank"
                  class="btn btn-icon btn-outline-primary"
                >
                ...
                <a
                  v-if="socialLinksinstagram_link"
                  :href="socialLinksinstagram_link"
                  target="_blank"
