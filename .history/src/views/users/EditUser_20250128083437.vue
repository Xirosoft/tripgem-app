          ...
          <div class="card-body">
            <form @submit.prevent="submitForm">
              <div class="row">
                <div class="col-md-6">
                  <div class="row mb-6">
                    <label class="col-sm-4 col-form-label" for="edit-user-firstname"
                      >First Name</label
                    >
                    <div class="col-sm-8">
                      <input
                  ...
                  <div class="row mb-6">
                    <label class="col-sm-4 col-form-label" for="edit-user-lastname"
                      >Last Name</label
                    >
                    <div class="col-sm-8">
                      <input
                  ...
                  <div class="row mb-6">
                    <label class="col-sm-4 col-form-label" for="edit-user-email">Email</label>
                    <div class="col-sm-8">
                      <input
                        type="email"
                        id="edit-user-email"
                  ...
                  <div class="row mb-6">
                    <label class="col-sm-4 col-form-label" for="edit-user-contact">Phone</label>
                    <div class="col-sm-8">
                      <input
                        type="text"
                  ...
                  <div class="row mb-6">
                    <label class="col-sm-4 col-form-label" for="parent-role">Parent Role</label>
                    <div class="col-sm-8">
                      <select
                        id="parent-role"
                        class="form-select"
                  ...
                  <div class="row mb-6">
                    <label class="col-sm-4 col-form-label" for="edit-user-role">User Role</label>
                    <div class="col-sm-8">
                      <select
                        id="edit-user-role"
                        class="form-select"
                  ...
                  <div class="row mb-6" v-if="companies.length > 0">
                    <label class="col-sm-4 col-form-label" for="edit-user-company">Company</label>
                    <div class="col-sm-8">
                      <select
                  ...
                  <div class="row mb-6">
                    <label class="col-sm-4 col-form-label" for="edit-user-status">Status</label>
                    <div class="col-sm-8">
                      <select
                        id="edit-user-status"
                        class="form-select"
                ...
                <div class="col-md-6">
                  <div class="row mb-6">
                    <label class="col-sm-4 col-form-label" for="edit-user-location">Location</label>
                    <div class="col-sm-8">
                      <select
                  ...
                  <div class="row mb-6">
                    <label class="col-sm-4 col-form-label" for="edit-user-profile-picture"
                  ...
                  <div class="row mb-6">
                    <label class="col-sm-4 col-form-label" for="edit-user-cover-photo"
                      >Cover Photo</label
                    >
                    <div class="col-sm-8">
                      <img
                  ...
                  <div class="row mb-6 select2-primary">
                    <label class="col-sm-4 col-form-label" for="edit-user-language"
                  ...
                  <div class="row mb-6">
                    <label class="col-sm-4 col-form-label" for="edit-user-bio">Bio</label>
                    <div class="col-sm-8">
                      <textarea
                        id="edit-user-bio"
                        class="form-control"
                  ...
                  <div class="row g-6">
                    <div class="col-md-6">
                      <div class="row">
                        <label class="col-sm-4 col-form-label" for="formtabs-twitter"
                          >Twitter</label
                        >
                        <div class="col-sm-8">
                          <input
                    ...
                    <div class="col-md-6">
                      <div class="row">
                        <label class="col-sm-4 col-form-label" for="formtabs-facebook"
                          >Facebook</label
                        >
                        <div class="col-sm-8">
                          <input
                    ...
                    <div class="col-md-6">
                      <div class="row">
                        <label class="col-sm-4 col-form-label" for="formtabs-line">Line</label>
                        <div class="col-sm-8">
                          <input
                            type="text"
                            id="formtabs-line"
                    ...
                    <div class="col-md-6">
                      <div class="row">
                        <label class="col-sm-4 col-form-label" for="formtabs-linkedin"
                          >LinkedIn</label
                        >
                        <div class="col-sm-8">
                          <input
                    ...
                    <div class="col-md-6">
                      <div class="row">
                        <label class="col-sm-4 col-form-label" for="formtabs-instagram"
                          >Instagram</label
                        >
                        <div class="col-sm-8">
                          <input
                    ...
                    <div class="col-md-6">
                      <div class="row">
                        <label class="col-sm-4 col-form-label" for="formtabs-tiktok">TikTok</label>
                        <div class="col-sm-8">
                          <input
                            type="text"
                            id="formtabs-tiktok"
