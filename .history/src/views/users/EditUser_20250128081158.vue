    ...
    <div class="col-xxl">
      <div class="card mb-6">
        <div class="card-header d-flex align-items-center justify-content-between">
          ...
          <RouterLink :to="`/users/profile/${userId}`" class="btn btn-primary">
            View Profile
          </RouterLink>
        </div>
        <div class="card-body">
          <form @submit.prevent="submitForm">
            <div class="row mb-6">
              <label class="col-sm-2 col-form-label" for="edit-user-firstname">First Name</label>
              <div class="col-sm-10">
                <input
                  type="text"
                  class="form-control"
            ...
            <div class="row mb-6">
              <label class="col-sm-2 col-form-label" for="edit-user-lastname">Last Name</label>
              <div class="col-sm-10">
                <input
                  type="text"
                  class="form-control"
            ...
            <div class="row mb-6">
              <label class="col-sm-2 col-form-label" for="edit-user-email">Email</label>
              <div class="col-sm-10">
                <input
                  type="email"
                  id="edit-user-email"
            ...
            <div class="row mb-6">
              <label class="col-sm-2 col-form-label" for="edit-user-contact">Phone</label>
              <div class="col-sm-10">
                <input
                  type="text"
            ...
            <div class="row mb-6">
              <label class="col-sm-2 col-form-label" for="parent-role">Parent Role</label>
              <div class="col-sm-10">
                <select
                  id="parent-role"
                  class="form-select"
            ...
            <div class="row mb-6">
              <label class="col-sm-2 col-form-label" for="edit-user-role">User Role</label>
              <div class="col-sm-10">
                <select
                  id="edit-user-role"
                  class="form-select"
            ...
            <div class="row mb-6" v-if="companies.length > 0">
              <label class="col-sm-2 col-form-label" for="edit-user-company">Company</label>
              <div class="col-sm-10">
                <select
            ...
            <div class="row mb-6">
              <label class="col-sm-2 col-form-label" for="edit-user-status">Status</label>
              <div class="col-sm-10">
                <select
                  id="edit-user-status"
                  class="form-select"
            ...
            <div class="row mb-6">
              <label class="col-sm-2 col-form-label" for="edit-user-location">Location</label>
              <div class="col-sm-10">
                <select
            ...
            <div class="row mb-6">
              <label class="col-sm-2 col-form-label" for="edit-user-profile-picture"
            ...
            <div class="row mb-6">
              <label class="col-sm-2 col-form-label" for="edit-user-cover-photo">Cover Photo</label>
              <div class="col-sm-10">
                <img
            ...
            <div class="row mb-6 select2-primary">
              <label class="col-sm-2 col-form-label" for="edit-user-language"
