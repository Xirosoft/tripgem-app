...
export default {
  ...
  methods: {
    initializeEditRoleModal(action) {
      const modalElement = this.editRoleModalRef
...
<template>
  ...
  <!-- Edit Role Modal -->
  <EditRoleModal v-if="selectedRoleId" :roleId="selectedRoleId"  @modal-open="initializeEditRoleModal('editRoleModal', action)" 
