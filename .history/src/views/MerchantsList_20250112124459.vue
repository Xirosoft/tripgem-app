<script>
import { merchantsList } from './MerchantsList.js'
...
export default {
  ...
  mounted() {
    ...
    const table = new DataTable('.datatables-products', this.dtOptions)

    // Your existing script loading code
          ...
          <div class="col-sm-6 col-lg-3">
            ...
            >
              ...
              <span class="avatar p-2 me-sm-6">
                <span class="avatar-initial rounded"
                  ><i class="ti-28px ti ti-gift text-heading"></i
                ></span>
              </span>
            </div>
          </div>
