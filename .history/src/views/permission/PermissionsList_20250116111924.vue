...
import $ from 'jquery'
import { usePermissionStore } from '../../stores/permission/PermissionList.js'
    ...
    initializeDataTable() {
      ...
      this.table = $(this.$refs.permissionsTable).DataTable({
        ...
        columns: [
          ...
          { data: 'role_id' }, // Assuming 'role_id' is the ID field
          { data: 'role_name' }, // Assuming 'role_name' is the name field
          { data: 'assigned_to' }, // Assuming 'assigned_to' is the assigned to field
          { data: 'created_date' }, // Assuming 'created_date' is the created date field
          {
            data: null,
            defaultContent: `
