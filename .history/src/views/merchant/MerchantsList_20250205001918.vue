            ...
            defaultContent: `
              <div class="d-inline-block">
                ...
                <div class="dropdown-menu">
                    <a v-if="this.uCan('write', 'merchant_module')" class="dropdown-item edit-merchant" href="javascript:void(0);"><i class="ti ti-pencil me-1"></i>Edit</a>
                    <a v-if="this.uCan('edit', 'merchant_module')" class="dropdown-item view-merchant" href="javascript:void(0);"><i class="ti ti-eye me-1"></i>View</a>
                    <a v-if="this.uCan('write', 'merchant_module')" class="dropdown-item text-danger delete-merchant" href="javascript:void(0);"><i class="ti ti-trash me-1"></i>Delete</a>
                </div>
              </div>
            `,
          },
