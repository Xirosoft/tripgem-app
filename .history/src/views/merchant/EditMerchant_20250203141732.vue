    ...
    async fetchMerchantData() {
      try {
        ...
        if (typeof this.formData.social_media_links === 'string') {
          const parsedLinks = JSON.parse(this.formData.social_media_links)
          this.formData.social_media_links = {
            facebook: decodeURIComponent(parsedLinks.facebook || ''),
            twitter: decodeURIComponent(parsedLinks.twitter || ''),
            instagram: decodeURIComponent(parsedLinks.instagram || ''),
            youtube: decodeURIComponent(parsedLinks.youtube || ''),
            line: decodeURIComponent(parsedLinks.line || ''),
          }
