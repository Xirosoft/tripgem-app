...
export default {
  ...
  methods: {
    ...
    handleLogoUpload(file) {
      DragAndDropUpload(file, this.formData, this.dropzone, this.toast, this.logo_url)
    },

    handleCoverPhoto(file) {
      DragAndDropUpload(file, this.formData, this.dropzoneCoverPhoto, this.toast, this.cover_photo)
    },
