  ...
  methods: {
    async fetchMerchantData() {
      try {
        ...
        this.uploadedCoverPhoto = this.formData.cover_photo.url || null
    ...
    async submitForm() {
      try {
        ...
        const submitData = {
          ...
          logo_url: this.formData.logo_url || this.uploadedLogo,
          cover_photo: this.formData.cover_photo || this.uploadedCoverPhoto,
        }
