              ...
              return `
                <div class="d-inline-block">
                  ...
                  <div class="dropdown-menu">
                    ${this.uCan('write', 'merchant_module') ? `
                      <a class="dropdown-item edit-merchant" href="javascript:void(0);">
                        <i class="ti ti-pencil me-1"></i>Edit
                      </a>
                    ` : ''}
                    ${this.uCan('edit', 'merchant_module') ? `
                      <a class="dropdown-item view-merchant" href="javascript:void(0);">
                        <i class="ti ti-eye me-1"></i>View
                      </a>
                    ` : ''}
                    ${this.uCan('write', 'merchant_module') ? `
                      <a class="dropdown-item text-danger delete-merchant" href="javascript:void(0);">
