...
import { handleFileUpload as uploadFiles } from '@/utils/fileUpload'
...
export default {
  ...
  setup() {
    ...
    return { toast, merchantStore, usersStore, uploadFiles }
  },
  data() {
    return {
      editor: null,
          ...
          <div class="card-body">
            <div class="mb-4">
              ...
              <input
                ...
                multiple
                accept=".pdf"
                @change="(e) => uploadFiles(e, 'business_permits')"
              />
            </div>
            <div class="mb-4">
              ...
              <input
                ...
                multiple
                accept=".pdf"
                @change="(e) => uploadFiles(e, 'membership_certificates')"
              />
            </div>
            <div class="mb-4">
              ...
              <input
                ...
                multiple
                accept=".pdf"
                @change="(e) => uploadFiles(e, 'documents')"
              />
            </div>
          </div>
        </div>
