  ...
  methods: {
    async fetchTourData(tourId) {
      ...
      try {
        ...
        console.log('drop_location:', this.tour.drop_location)
        console.log('pick_up_location:', this.tour.pick_up_location)
    ...
    async fetchBookingData(bookingId) {
      ...
      try {
        ...
        console.log('drop_location:', this.booking.drop_location)
        console.log('pick_up_location:', this.booking.pick_up_location)
