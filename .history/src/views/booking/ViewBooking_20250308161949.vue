  ...
  <div class="flex-grow-1 container-p-y container-fluid">
    ...
    >
      ...
      <div class="d-flex align-content-center flex-wrap gap-2">
        <button class="btn btn-label-info delete-order waves-effect">View Tour</button>
      ...
      <div class="col-12 col-lg-4">
        ...
        <div class="card mb-6">
          ...
          <div class="card-body">
            <p class="mb-0">
              <ul>
                <li><b>Pick Up: </b><span>{{ booking.pick_up_location }}</span> </li>
                <li><b>Pick Up: </b><span>{{ booking.drop_location }} </span></li>
                <li><b>Pick Up: </b> <span>{{ booking.nationality }} </span></li>
              </ul>
            </p>
          </div>
        </div>
