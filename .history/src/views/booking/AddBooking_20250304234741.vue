...
export default {
  ...
  methods: {
    ...
    calculateParkFee() {
      const adultFee = parseFloat(this.booking.adult_park_fee) || 0
      const childFee = parseFloat(this.booking.child_park_fee) || 0
      return (
                              ...
                              <div class="col-6">
                                <div class="d-flex flex-column">
                                  ...
                                  <input
                                    type="number"
                                    class="form-control form-control-sm"
                                    v-model="booking.adult_park_fee"
                              ...
                              <div class="col-6">
                                <div class="d-flex flex-column">
                                  ...
                                  <input
                                    type="number"
                                    class="form-control form-control-sm"
                                    v-model="booking.child_park_fee"
                            ...
                            <div class="">
                              ...
                              <div class="d-flex justify-content-between mb-0">
                                ...
                                <span class="text-primary fw-bold">
                                  ฿{{ booking.adult_park_fee }}
                                </span>
                              </div>
                              <div class="d-flex justify-content-between">
                                <span>Child Fee:</span>
                                <span class="text-primary fw-bold">
                                  ฿{{ booking.child_park_fee }}
                                </span>
                              </div>
                            </div>
                          </div>
