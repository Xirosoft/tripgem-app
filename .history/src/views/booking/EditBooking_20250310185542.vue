  ...
  methods: {
    ...
    async fetchBookingData(bookingId) {
      ...
      try {
        ...
        // this.tour.nationality = 'Bangladesh'
        // this.tour.drop_time = this.tour.drop_time
        // this.tour.nationality = this.tour
        // console.log('Booking:', this.tour)
        // console.log(this.tour.nationality)
              ...
              <div class="col-md-4 mb-6">
                ...
                <div class="input-group input-group-merge">
                  ...
                  >
                    ...
                    <option
                      v-for="location in parsePickupLocations(tour.pick_up_time)"
              ...
              <div class="col-md-4 mb-6">
                ...
                <div class="input-group input-group-merge">
                  ...
                  >
                    <option value="">Select Location</option>
                    <option
                      v-for="location in parseDropLocations(tour.drop_time)"
                      :key="location.location"
                      :value="location"
                    >
