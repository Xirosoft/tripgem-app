  ...
  methods: {
    async fetchTourData(tourId) {
      ...
      try {
        ...
        this.booking.net_adult_price = this.tour.net_adult_price
        this.booking.net_child_price = this.tour.net_child_price
    ...
    async fetchBookingData(bookingId) {
      ...
      try {
        ...
        console.log('Booking data:', this.booking.num_traveler_adult)
