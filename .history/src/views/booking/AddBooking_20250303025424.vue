  ...
  methods: {
    async fetchTourData(tourId) {
      ...
      try {
        ...
        console.log('Tour data:', this.tour[0])

        this.booking = this.tour
        this.booking.tour_id = this.tour.id
        this.booking.tour_name = this.tour.name
        this.booking.merchant_id = this.tour.merchant_id
        this.booking.adult_price = this.tour.adult_price
        this.booking.child_price = this.tour.child_price
    ...
    <div class="row">
      ...
      <div class="col-md-6 mb-6">
        ...
        <div class="input-group input-group-merge">
          ...
          <input type="email" class="form-control" v-model="booking.email" id="email" required />
        </div>
      </div>
      <div class="col-md-6 mb-6">
      ...
      <div class="col-md-6 mb-6">
        ...
        <div class="input-group input-group-merge">
          ...
          <input
            type="number"
            class="form-control"
            v-model="booking.total_traveller"
            id="total_traveller"
            required
          />
        </div>
      ...
      <div class="col-md-6 mb-6">
        ...
        <div class="input-group input-group-merge">
          ...
          <input type="text" class="form-control" v-model="booking.status" id="status" required />
        </div>
      </div>
      <div class="col-md-6 mb-6">
