  ...
  <div class="flex-grow-1 container-p-y container-fluid">
    ...
    >
      ...
      <div class="d-flex align-content-center flex-wrap gap-2">
        <button class="btn btn-label-danger delete-order waves-effect">Edit</button>
        <button class="btn btn-label-danger delete-order waves-effect">View Tour</button>
    ...
    <div class="row">
              ...
              <li class="timeline-item timeline-item-transparent border-primary">
                ...
                <div class="timeline-event">
                  <div class="timeline-header">
                    <h6 class="mb-0">
                      Booking was placed (Booking ID: #{{ viewBookingsStore.booking.booking_id }})
                    </h6>
      ...
      <div class="col-12 col-lg-4">
        ...
        <div class="card mb-6">
          ...
          <div class="card-body">
            <p class="mb-0">
              {{ viewBookingsStore.booking.pick_up_location }} <br />{{
                viewBookingsStore.booking.drop_location
              }}
              <br />{{ viewBookingsStore.booking.hotel_name }} <br />{{
                viewBookingsStore.booking.nationality
              }}
            </p>
          </div>
        </div>
