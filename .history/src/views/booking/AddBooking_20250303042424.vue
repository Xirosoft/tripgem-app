  ...
  methods: {
    ...
    updatePickupTimes() {
      if (this.booking.selectedLocation) {
        this.booking.pick_up_time = `${this.booking.selectedLocation.from} - ${this.booking.selectedLocation.to}`
      } else {
        this.booking.pick_up_time = ''
      }
    },
  },
  mounted() {
      ...
      <div class="col-md-6 mb-6">
        ...
        <div class="input-group input-group-merge">
          ...
          >
            ...
            <option
              v-for="pick_up_time in parsePickupLocations(booking.pick_up_time)"
              :key="pick_up_time.location"
              :value="location"
            >
              {{ pick_up_time.location }} ({{
                pick_up_time.location ? '฿' + pick_up_time.location : 'Free'
              }})
            </option>
          </select>
        </div>
      ...
      <div class="col-md-6 mb-6">
        ...
        <div class="input-group input-group-merge">
          ...
          >
            ...
            <option v-if="booking.selectedLocation">
              {{ booking.selectedLocation.from }} - {{ booking.selectedLocation.to }}
            </option>
          </select>
        </div>
      </div>
