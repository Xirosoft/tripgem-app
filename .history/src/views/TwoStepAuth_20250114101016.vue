...
export default {
  ...
  setup() {
    ...
    // Fetch the email from the user's registration data
    const fetchUserEmail = () => {
      // Assuming the email is stored in the Pinia store after registration
      if (!userStore.email) {
        userStore.setEmail(localStorage.getItem('userEmail') || '')
      }
    }
