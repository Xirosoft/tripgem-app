...
const loadTourDetails = async () => {
  try {
    ...
    // setTimeout(() => {
    //   $('#location').val(FilterLocation.value).trigger('change')
    //   console.log('Selected Location: ', FilterLocation.value)
    // }, 5000)
  } catch (error) {
      ...
      <div class="col-12 col-lg-4">
        ...
        <div class="card mb-6">
          ...
          <div class="card-body">
            ...
            />
            <TourLocation :selectedLocation="formData.location" />
            <TourLocation :selectedLocation="FilterLocation.value" />
