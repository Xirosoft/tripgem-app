...
const handleFileUpload = async (file, key) => {
  await DragAndDropUpload(file, formData.value, null, null, key)
}
...
const initializeDropzone = (elementId, key) => {
...
onMounted(() => {
  ...
  initializeDropzone('#thumbnail', 'thumbnail')
  initializeDropzone('#image_gallery', 'image_gallery')
  initializeDropzone('#video_gallery', 'video_gallery')
})
</script>
