              ...
              <div class="col-12 col-md-8 col-xl-7 col-xxl-8 pt-6 pt-md-0">
                <div class="tab-content p-0 ps-md-4">
                  ...
                  <div class="tab-pane fade show active" id="AdultPrice" role="tabpanel">
                    ...
                    <div class="col-12">
                      <label class="form-label" for="ecommerce-product-stock">Regular Price</label>
                      <input
                        type="number"
                        class="form-control"
                    ...
                    <div class="col-12">
                      <label class="form-label" for="ecommerce-product-stock">Net Price</label>
                      <input
                        type="number"
                        class="form-control"
                        id="ecommerce-product-stock"
                    ...
                    <div class="col-12">
                      <label class="form-label" for="ecommerce-product-stock"
                  ...
                  <div class="tab-pane fade" id="shipping" role="tabpanel">
                    ...
                    <div class="col-12">
                      <label class="form-label" for="ecommerce-product-stock">Discount Price</label>
                      <input
                        type="number"
                        class="form-control"
                        id="ecommerce-product-stock"
                        placeholder="Disscount Price"
                        name="quantity"
                        aria-label="Quantity"
                      />
                    </div>
