...
const loadTourDetails = async () => {
  try {
    ...
    console.log(formData.value.location[0].name)
    ...
    setTimeout(() => {
      ...
      $('#location')
        .val(
          formData.value.location[0].name?.charAt(0).toUpperCase() +
            formData.value.location[0].name?.slice(1),
        )
        .trigger('change')
    }, 0)
  } catch (error) {
      ...
      <div class="col-12 col-lg-4">
        ...
        <div class="card mb-6">
          ...
          <div class="card-body">
            ...
            />
            <TourLocation
              :initialLocation="formData.value.location[0]"
