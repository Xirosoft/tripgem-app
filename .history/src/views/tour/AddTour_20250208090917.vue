                ...
                <div data-repeater-item>
                  <div class="row">
                    <div class="mb-6 col-4">
                      <label class="form-label" for="form-repeater-1-1">Meta Options</label>
                      <input
                        type="text"
                        id="form-repeater-1-1"
                        class="form-control"
                        placeholder="Enter option"
                        v-model="formData.tour_meta.guide_name"
                      />
                    </div>

                    <div class="mb-6 col-8">
                      <label class="form-label" for="form-repeater-1-2">Meta Value</label>
                      <input
                        type="number"
                        id="form-repeater-1-2"
                        class="form-control"
                        placeholder="Enter Value"
                        v-model="formData.tour_meta.meeting_point"
                      />
                    </div>
                  </div>
                </div>
