            ...
            >
              <div class="row w-100 pt-2 pb-2">
                <div class="col-md-3">
                  ...
                  />
                  <div class="opar">
                    <i class="ti ti-external-link ti-md"></i> {{ tour.merchant_name }}
                  </div>
                </div>
                <div class="col-md-7">
                          ...
                          <div class="d-flex flex-grow-1 align-items-center">
                            ...
                            <div class="progress w-100 me-4" style="height: 8px">
                              <div
                                class="progress-bar"
                                :class="{
                                  'bg-danger': (tour.available_seat / tour.total_seat) * 100 <= 30,
                                  'bg-warning':
                                    (tour.available_seat / tour.total_seat) * 100 > 30 &&
                                    (tour.available_seat / tour.total_seat) * 100 <= 70,
                                  'bg-success': (tour.available_seat / tour.total_seat) * 100 > 70,
                                }"
                                role="progressbar"
                                :style="{
