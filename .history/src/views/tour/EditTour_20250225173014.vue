...
const loadTourDetails = async () => {
  try {
    ...
    formData.value.location = formData.value.location[0].name

    console.log('location', formData.value.location)
      ...
      <div class="col-12 col-lg-4">
        ...
        <div class="card mb-6">
          ...
          <div class="card-body">
            ...
            />
            <TourLocation :selectedLocation="formData.value.location" />
