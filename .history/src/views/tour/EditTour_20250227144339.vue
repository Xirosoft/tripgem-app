...
const handleSubmit = async () => {
  try {
    ...
    formData.value.location = FilterLocation.value ? [{ name: FilterLocation.value }] : []
    formData.value.category = FilterCategory.value ? { category_name: FilterCategory.value } : {}
    formData.value.tags = FilterTags.value

    console.log('Form Data:', formData.value.location)
    console.log('Form Data:', formData.value.category)
    console.log('Form Data:', formData.value.tags)
