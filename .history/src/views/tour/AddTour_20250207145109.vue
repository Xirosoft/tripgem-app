          ...
          <div class="card-body">
            ...
            <div>
              ...
              <div class="form-control p-0">
                ...
                <div class="comment-editor border-0 pb-6" id="tour-category-description"></div>
              </div>
            </div>
            <div>
              ...
              <div class="form-control p-0">
                ...
                <div class="comment-editor border-0 pb-6" id="tour-category-itinerary"></div>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div class="tab-pane fade show active" id="AdultPrice" role="tabpanel">
                    ...
                    <div class="col-12 mb-3">
                      ...
                      <input
                        ...
                        min="0"
                        step="0.01"
                        v-model="adultPricing.regularPrice"
                      />
                    </div>
                    <div class="col-12 mb-3">
                    ...
                    <div class="col-12">
                      ...
                      <input
                        ...
                        min="0"
                        step="0.01"
                        v-model="adultPricing.discountedPrice"
                      />
                    </div>
                  </div>
                  <!-- Child Price Tab -->
                  <div class="tab-pane fade" id="shipping" role="tabpanel">
                    ...
                    <div class="col-12 mb-3">
                      ...
                      <input
                        ...
                        min="0"
                        step="0.01"
                        v-model="childPricing.regularPrice"
                      />
                    </div>
                    <div class="col-12 mb-3">
                    ...
                    <div class="col-12">
                      ...
                      <input
                        ...
                        min="0"
                        step="0.01"
                        v-model="childPricing.discountedPrice"
                      />
                    </div>
                  </div>
                </div>
