...
onMounted(() => {
  ...
  // Replace deprecated DOMNodeInserted event listener with MutationObserver
        ...
        <div class="card mb-6">
          ...
          <div class="card-body">
            ...
            <div>
              ...
              <QuillEditor v-model="formData.description" placeholder="Description" />
            </div>
            <div class="mt-5">
              <label class="mb-1">Itinerary (Optional)</label>
              <QuillEditor v-model="formData.itinerary" placeholder="Itinerary" />
            </div>
            <div class="mb-6 mt-6">
