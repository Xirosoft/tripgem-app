                    ...
                    <ul class="p-0 m-0">
                      <li class="mb-2 d-flex justify-content-between align-items-center">
                        <div class="badge bg-label-secondary rounded p-1">
                          <b><i class="ti ti-circle-check"></i></b>
                        </div>
                        <div class="d-flex justify-content-between w-100 flex-wrap">
                          <h6 class="mb-0 ms-4"><b>Details</b></h6>
                          <div class="d-flex">
                            <p class="mb-0"><b>Net</b></p>
                            <p class="ms-4 mb-0"><b>Regular</b></p>
                          </div>
                        </div>
                      </li>
                      <li class="mb-2 d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex justify-content-between w-100 flex-wrap">
                          ...
                          <div class="d-flex">
                            <p class="mb-0">{{ tour.net_price_adult }}</p>
                            <p class="ms-4 text-success mb-0">{{ tour.regular_price_adult }}</p>
                          </div>
                        </div>
                      </li>
                      <li class="mb-2 d-flex justify-content-between align-items-center">
                        <div class="badge bg-label-info rounded p-1">
                          <i class="ti ti-link ti-md"></i>
                        </div>
                        <div class="d-flex justify-content-between w-100 flex-wrap">
                          <h6 class="mb-0 ms-4">Child Price</h6>
                          <div class="d-flex">
                            <p class="mb-0">{{ tour.net_price_child }}</p>
                            <p class="ms-4 text-success mb-0">{{ tour.regular_price_child }}</p>
                          </div>
                        </div>
                      </li>
                      <li class="mb-2 d-flex justify-content-between align-items-center">
                        <div class="badge bg-label-primary rounded p-1">
