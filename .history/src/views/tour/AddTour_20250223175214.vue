...
const handleSubmit = async () => {
  try {
    formData.value.available_dates = {
      from: formData.value.available_dates_from,
      to: formData.value.available_dates_to,
    }
                  ...
                  <div class="tab-pane fade" id="pickupTime" role="tabpanel">
                    ...
                    <div class="mb-3">
                      ...
                      <input
                        ...
                        class="form-control"
                        id="pickupTimeStart"
                        v-model="formData.pick_up_time_start"
                      />
                    </div>
                    <div class="mb-3">
                      ...
                      <input
                        ...
                        class="form-control"
                        id="pickupTimeEnd"
                        v-model="formData.pick_up_time_end"
                      />
                    </div>
                  </div>
                  <!-- Drop-off Time Tab -->
                  <div class="tab-pane fade" id="dropoffTime" role="tabpanel">
                    ...
                    <div class="mb-3">
                      ...
                      <input
                        ...
                        class="form-control"
                        id="dropoffTimeStart"
                        v-model="formData.drop_time_start"
                      />
                    </div>
                    <div class="mb-3">
                      <label class="form-label">To</label>
                      <input
                        ...
                        class="form-control"
                        id="dropoffTimeEnd"
                        v-model="formData.drop_time_end"
                      />
                    </div>
                  </div>
                  <!-- Tour Dates Tab -->
                    ...
                    <div class="row mb-4">
                      <div class="col-md-6">
                        ...
                        <input
                          ...
                          id="tourStartDate"
                          name="tourStartDate"
                          v-model="formData.available_dates.from"
                        />
                      </div>
                      <div class="col-md-6">
                        ...
                        <input
                          ...
                          id="tourEndDate"
                          name="tourEndDate"
                          v-model="formData.available_dates.to"
                        />
                      </div>
                    </div>
                    <div class="mb-4">
