    ...
    <div class="col-md-2 left-sidebar-filter">
      ...
      <div class="mb-3">
        ...
        <input
          ...
          max="10000"
        />
        <div>Min: {{ priceMin }} - Max: {{ priceMax }}</div>
      </div>
      <div class="mb-3">
        <label class="form-label">Transport Types</label>
        <div>
          <input type="checkbox" id="transport1" value="Bus" v-model="transportTypes" />
          <label for="transport1">Bus</label>
        </div>
        <div>
          <input type="checkbox" id="transport2" value="Boat" v-model="transportTypes" />
          <label for="transport2">Boat</label>
        </div>
        <div>
          <input type="checkbox" id="transport3" value="Car" v-model="transportTypes" />
          <label for="transport3">Car</label>
        </div>
      </div>
      <div class="mb-3">
        <label class="form-label">Languages Supported</label>
        <div>
          <input type="checkbox" id="language1" value="English" v-model="languagesSupported" />
          <label for="language1">English</label>
        </div>
        <div>
          <input type="checkbox" id="language2" value="French" v-model="languagesSupported" />
          <label for="language2">French</label>
        </div>
        <div>
          <input type="checkbox" id="language3" value="Spanish" v-model="languagesSupported" />
          <label for="language3">Spanish</label>
        </div>
      </div>
      <div class="mb-3">
        <label class="form-label">Pick Up Time</label>
        <div>
          <input type="checkbox" id="pickup1" value="Morning" v-model="pickUpTime" />
          <label for="pickup1">Morning</label>
        </div>
        <div>
          <input type="checkbox" id="pickup2" value="Afternoon" v-model="pickUpTime" />
          <label for="pickup2">Afternoon</label>
        </div>
        <div>
          <input type="checkbox" id="pickup3" value="Evening" v-model="pickUpTime" />
          <label for="pickup3">Evening</label>
        </div>
      </div>
      <div class="mb-3">
        <label class="form-label">Drop Off Time</label>
        <div>
          <input type="checkbox" id="drop1" value="Morning" v-model="dropTime" />
          <label for="drop1">Morning</label>
        </div>
        <div>
          <input type="checkbox" id="drop2" value="Afternoon" v-model="dropTime" />
          <label for="drop2">Afternoon</label>
        </div>
        <div>
          <input type="checkbox" id="drop3" value="Evening" v-model="dropTime" />
          <label for="drop3">Evening</label>
        </div>
      </div>
    </div>
    <div class="col-md-7">
              ...
              <div class="w-100">
                <div class="d-flex justify-content-between">
                  <div class="user-info">
                    ...
                    <div class="user-status">
                      <span class="badge badge-dot bg-info"></span>
                      <small>Tour Oparetor: {{ tour.merchant_name }}</small>
                    </div>
                  </div>
                  <div class="add-btn">
                    <button
