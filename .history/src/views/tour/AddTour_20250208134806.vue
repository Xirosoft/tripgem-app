...
onMounted(() => {
  ...
  this.dropzoneThumbnail = initializeDropzone('#thumbnail', handleThumbnailUpload)
  this.dropzoneImageGallery = initializeDropzone('#image_gallery', handleImageGalleryUpload)
  this.dropzoneVideoGallery = initializeDropzone('#dropzone-basic', handleVideoGalleryUpload)
})
</script>
