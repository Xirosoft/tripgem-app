...
const loadTourDetails = async () => {
  try {
    ...
    selectedLocation.value = formData.value.location[0]?.location_id.toString() || '' // Set initial location
      ...
      <div class="col-12 col-lg-4">
        ...
        <div class="card mb-6">
          ...
          <div class="card-body">
            ...
            />
            <TourLocation :selectedLocation="formData.value.location[0]?.location_id.toString()" />
