...
const handleThumbnailUpload = async (event, key) => {
  const uploadedFiles = await handleFileUpload(event, key)
  if (uploadedFiles.length > 0) {
    formData.value.thumbnail = uploadedFiles[0].url
  }
}
        ...
        <div class="card mb-6">
          ...
          <div class="card-body">
            ...
            <div>
              ...
              <QuillEditor v-model="formData.description" theme="snow" placeholder="Description" />
            </div>
            <div class="mt-5">
              <label class="mb-1">Itinerary (Optional)</label>
              <QuillEditor v-model="formData.itinerary" theme="snow" placeholder="Itinerary" />
            </div>
            <div class="mb-6 mt-6">
                  ...
                  <div class="tab-pane fade show active" id="photoGallery" role="tabpanel">
                    ...
                    <div class="card mb-6">
                      <div class="card-body">
                        <form
                          action="/upload"
                          class="dropzone needsclick p-0"
                          id="image_gallery"
                          @change="handleFileUpload($event, 'image_gallery')"
                        >
                    ...
                    <div class="card mb-6">
                      <div class="card-body">
                        <form
                          ...
                          class="dropzone needsclick p-0"
                          id="dropzone-basic"
                          @change="handleFileUpload($event, 'video_gallery')"
                        >
                          <div class="dz-message needsclick">
                            <p class="h4 needsclick pt-3 mb-2">Drag and drop your image here</p>
                            <p class="h6 text-muted d-block fw-normal mb-2">or</p>
