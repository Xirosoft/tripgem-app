            ...
            <div class="row">
                    ...
                    <ul class="nav nav-pills flex-column w-100">
                      ...
                      <li class="nav-item">
                        <button
                          class="nav-link"
                          data-bs-toggle="tab"
                          data-bs-target="#total_seattotal_seat"
                        >
                          <i class="ti ti-lock ti-sm me-1_5"></i>
                          <span class="align-middle">total_seattotal_seat</span>
                        </button>
                      </li>
                    </ul>
                  </div>
              ...
              <div class="col-12 col-md-8 col-xl-7 col-xxl-8 pt-6 pt-md-0">
                <div class="tab-content p-0 ps-md-4">
                  ...
                  <!-- tour_end_time Tab -->
                  <div class="tab-pane fade" id="tour_end_time" role="tabpanel">
                    <h6 class="mb-3 text-body">tour_end_time Type</h6>
                    <div>
                  ...
                  <!-- /available_seat Tab -->
                  <!-- total_seattotal_seat Tab -->
                  <div class="tab-pane fade" id="total_seattotal_seat" role="tabpanel">
                    <h6 class="mb-3 text-body">total_seattotal_seat</h6>
                    <div class="row">
                      <!-- Product Id Type -->
                      <div class="col">
