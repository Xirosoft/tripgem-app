<script setup>
import { useViewStore } from '../../stores/tour/ViewTour.js'
</script>
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center flex-wrap mb-6 gap-2">
              <div class="me-1">
                ...
                <p class="mb-0">
                  Prof. <span class="fw-medium text-heading"> Devonne Wallbridge </span>
                </p>
              </div>
            ...
            <div class="card academy-content shadow-none border">
              ...
              <div class="card-body pt-4">
                ...
                <p class="mb-0">
                  Learn web design in 1 hour with 25+ simple-to-use rules and guidelines — tons of
                  amazing web design resources included!
                </p>
                <hr class="my-6" />
                ...
                <p class="mb-6">
                  ...
                  and development with HTML5 & CSS3. Scroll to the bottom of this page to check out
                  that course, too! If you're already taking my other course, you already have all
                  it takes to start designing beautiful websites today!
                </p>
                <p class="mb-6">
                ...
                <p>
                  "Very helpful to us left-brained people: I am familiar with HTML, CSS, JQuery, and
                  Twitter Bootstrap, but I needed instruction in web design. This course gave me
                  practical, impactful techniques for making websites more beautiful and engaging."
                  — Susan Darlene Cain
                </p>
                <hr class="my-6" />
                <h5>Instructor</h5>
