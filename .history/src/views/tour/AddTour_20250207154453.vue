              ...
              <div class="col-12 col-md-8 col-xl-7 col-xxl-8 pt-6 pt-md-0">
                <div class="tab-content p-0 ps-md-4">
                  ...
                  <div class="tab-pane fade" id="tour_end_time" role="tabpanel">
                    ...
                    <input type="time" class="form-control" id="tour_end_time_from" />
                    <p>To</p>
                    <input type="time" class="form-control" id="tour_end_time_end" />
                  </div>
                  <!-- Global Delivery Tab -->
                  <div class="tab-pane fade" id="available_dates" role="tabpanel">
                    <h6 class="mb-3 text-body">Available Dates</h6>
                    <!-- Worldwide delivery -->
                    <div class="mb-4">
                      <div class="row">
                        <div class="col-md-6">
                          <label class="form-label">Start Date</label>
                          <input type="date" class="form-control" id="available_start_date" />
                        </div>
                        <div class="col-md-6">
                          <label class="form-label">End Date</label>
                          <input type="date" class="form-control" id="available_end_date" />
                        </div>
                      </div>
                    </div>
                    <div class="mb-4">
                  ...
                  <div class="tab-pane fade" id="total_seat" role="tabpanel">
                    <h6 class="mb-3 text-body">Total Seat</h6>
                    <input type="number" class="form-control" id="total_seat" />
                  </div>
                  <!-- /total_seat Tab -->

                  <!-- available_seat Tab -->
                  <div class="tab-pane fade" id="available_seat" role="tabpanel">
                    <h6 class="mb-2 text-body"><A></A>vailable Seat</h6>
                    <input type="number" class="form-control" id="available_seat" />
                  </div>
                  <!-- /available_seat Tab -->
                </div>
              </div>
