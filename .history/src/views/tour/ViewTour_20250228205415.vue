...
<template>
  <!-- Content -->
  <div class="container-fluid flex-grow-1 container-p-y" v-if="tourDetails">
    <div class="row g-6">
      <div class="col-lg-8">
        <div class="card">
          <div class="card-body">
            ...
            <div class="card-body pt-4">
              ...
              <p>
                <strong>Local Net Price (Adult):</strong> {{ tourDetails.local_net_price_adult }}
              </p>
              <p>
                <strong>Local Net Price (Child):</strong> {{ tourDetails.local_net_price_adult }}
              </p>
