    ...
    async submitForm() {
      ...
      try {
        ...
        try {
          ...
          this.$toast.error('Failed to upload one or more files')
          return
        }
        ...
        const submitData = {
          ...this.formData,
          logo_url: uploadedUrls.logo || this.formData.logo_url,
        ...
        // Submit to store
        const result = await store.createMerchant(submitData)
