...
import { triggerPusherEvent } from '../../utils/pusher' // Import Pusher utility
    ...
    async addPermission(payload) {
      ...
      try {
        ...
        if (response.data.success) {
          ...
          triggerPusherEvent('permissions-updates', 'update', { permissions: this.permissions }) // Trigger Pusher update
        } else {
