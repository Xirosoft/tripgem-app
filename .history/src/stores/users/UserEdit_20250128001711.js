  ...
  actions: {
    ...
    async fetchUserDetails(userId) {
      try {
        ...
        console.log(response.data.data.usermeta.location)

        if (response) {
          this.userData = response.data.data
          this.userData.meta = this.userData.usermeta || {}
          this.userData.meta.location = response.data.data.usermeta.location
