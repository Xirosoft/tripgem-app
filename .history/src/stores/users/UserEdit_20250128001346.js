    ...
    async fetchUserDetails(userId) {
      try {
        ...
        if (response) {
          ...
          this.userData.usermeta = this.userData.meta || {}
          this.userData.usermeta.location = this.userData.meta.location || { value: '' }
          this.userData.usermeta.profile_picture = this.userData.meta.profile_picture || {
            value: '',
          }
          this.userData.usermeta.cover_photo = this.userData.meta.cover_photo || { value: '' }
          this.userData.usermeta.language = this.userData.meta.language || { value: '' }
