  ...
  actions: {
    ...
    async fetchBookingData(bookingId) {
      ...
      try {
        ...
        this.booking.tour_id = response.data.tour_id
        this.booking.tour_name = response.data.tour_name
        this.booking.merchant_id = response.data.merchant_id
        this.booking.adult_price = response.data.adult_price
        this.booking.child_price = response.data.child_price
        this.booking.total_price = response.data.total_price
        this.booking.location = response.data.location
        this.booking.merchant_name = response.data.merchant_name
        this.booking.user_name = response.data.user_name
        this.booking.available_seat = response.data.available_seat
        this.booking.pick_up_time = response.data.pickup_time
        this.booking.thumbnail = response.data.thumbnail
        this.booking.park_fee = response.data.park_fee
        this.booking.discount = response.data.discount
        this.booking.discountDetails = response.data.discountDetails
        this.booking.nationality = response.data.nationality
        this.booking.pick_up_location = response.data.pick_up_location
        this.booking.drop_off_location = response.data.drop_location
        this.booking.pick_up_time_from = response.data.pickup_time
        this.booking.drop_time_from = response.data.drop_time
        this.booking.net_adult_price = response.data.net_adult_price
        this.booking.net_child_price = response.data.net_child_price
      } catch (error) {
