...
export function initializeAddTour() {
  ...
  ;(function () {
    ...
    window.dropzoneThumbnail = initializeDropzone('#thumbnail', handleLogoUpload)
    window.dropzoneImageGallery = initializeDropzone('#image_gallery', handleCoverPhotoUpload)
    window.dropzoneVideoGallery = initializeDropzone('#dropzone-basic', handleCoverPhotoUpload)
