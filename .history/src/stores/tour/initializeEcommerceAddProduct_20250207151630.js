...
export function initializeEcommerceAddProduct() {
  'use strict'
  ...
  ;(function () {
    ...
    initCommentEditor('.tour-description-editor', '.comment-toolbar', 'Product Description')
    initCommentEditor('.tour-category-itinerary', '.comment-toolbar', 'Tour Itinerary')
