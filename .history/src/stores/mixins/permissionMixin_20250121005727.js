  ...
  methods: {
    ...
    uCan(action, permissionName) {
      ...
      return actions.some((act) => {
        switch (act) {
          case permission.can_read === 1:
            return true
          case permission.can_write === 1:
            return true
          case permission.can_create === 1:
            return true
          case permission.can_read === 0:
            return false
          case permission.can_write === 0:
            return false
          case permission.can_create === 0:
            return false
          default:
            return false
        }
