  ...
  setup(props, { emit }) {
    ...
    const loadCities = async () => {
      try {
        ...
        // Fix: Use the correct API endpoint and payload
        const response = await axios.post(
          'https://countriesnow.space/api/v0.1/countries/cities', // Changed API endpoint
          {
        ...
        if (response.data?.data) {
          // Filter cities based on available data
          ...
          // Enable city select and initialize select2
