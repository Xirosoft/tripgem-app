...
<template>
  <ul class="dropdown-menu dropdown-menu-end">
    <li>
        <router-link class="dropdown-item  mt-0" :to="{ name: 'ViewUser', params: { userId: user.value.id } }"></router-link>
      ...
      <router-link class="dropdown-item" :to="{ name: 'ViewUser', params: { userId: user.value.id } }">
