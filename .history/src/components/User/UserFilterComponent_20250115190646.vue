<template>
  <div class="row pb-2 gap-3 gap-md-0">
    ...
    <div class="col-md-3 dt-buttons btn-group flex-wrap">
      <div class="btn-group">
        <button
          class="btn btn-secondary buttons-collection dropdown-toggle btn-label-secondary mx-4 waves-effect waves-light"
          tabindex="0"
          ...
          aria-expanded="false"
        >
          <span><i class="ti ti-upload me-2 ti-xs"></i>Export</span>
        </button>
      </div>
      <button class="dt-button add-new btn btn-primary" @click="$emit('add-user')">
        <span>
