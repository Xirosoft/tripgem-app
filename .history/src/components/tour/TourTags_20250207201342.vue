...
const initializeSelect2 = () => {
  $(tagSelectRef.value)
    .off('select2:select select2:unselect') // Remove previous event handlers
    .select2({
      tags: true,
    ...
    .val(selectedTags.value) // Set the selected tags
    .trigger('change') // Trigger change to update the UI
