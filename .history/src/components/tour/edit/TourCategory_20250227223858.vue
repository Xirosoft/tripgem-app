...
const initializeSelect2 = () => {
  ...
  nextTick(() => {
    console.log('Initializing select2 with categories:', categories.value)
    $(categorySelectRef.value)
      ...
      .on('select2:select', (e) => {
        ...
        console.log(
          'Selected Category:',
          categories.value.find((category) => category.category_id.toString() === selectedId),
        )
        ...
        console.log('Selected Category1:', selectedCategory)
      })
      .val(
    ...
    console.log('Selected Category2:', props.selectedCategory)
  })
}
