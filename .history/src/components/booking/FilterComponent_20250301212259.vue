...
// Configure daterangepicker to use dayjs instead of moment
window.moment = (...args) => {
  const instance = dayjs(...args)
  instance.isValid = () => instance.isValid()
  instance.format = (format) => instance.format(format)
  instance.startOf = (unit) => instance.startOf(unit)
  instance.endOf = (unit) => instance.endOf(unit)
  instance.subtract = (amount, unit) => instance.subtract(amount, unit)
  return instance
}
