    ...
    return {
      ...
      menuItems: [
        ...
        },
        {
          ...
          icon: 'ti ti-package',
          active: false,
          // permission: 'tour_module',
          submenu: [
            {
              title: 'All Tours', // All Tours
              path: '/all-tours',
              active: false,
            },
            {
              title: 'Add tour', // Add Tour
              path: '/all-boookings',
              active: false,
            },
            {
