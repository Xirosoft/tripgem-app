      ...
      if (role) {
        ...
        try {
          ...
          rolePermissions.forEach((permission) => {
            document.getElementById(`${permission.permission_id}_read`).checked =
              permission.can_read === '1'
            document.getElementById(`${permission.permission_id}_write`).checked =
              permission.can_write === '1'
            document.getElementById(`${permission.permission_id}_create`).checked =
