      ...
      if (role) {
        ...
        try {
          ...
          rolePermissions.forEach((permission) => {
            const readCheckbox = document.getElementById(`${permission.permission_id}_read`)
            const writeCheckbox = document.getElementById(`${permission.permission_id}_write`)
            const createCheckbox = document.getElementById(`${permission.permission_id}_create`)
