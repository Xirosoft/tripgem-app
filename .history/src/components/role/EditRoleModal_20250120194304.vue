...
import { handlePermissionUpdate } from '../../stores/mixins/permissionMixin'
    ...
    async editRole() {
      ...
      try {
        ...
        if (!rolesListStore.error) {
          ...
          handlePermissionUpdate.handlePermissionUpdate(formattedResponse)
          console.log('Triggering Pusher event with data:', formattedResponse)
          TgHandlePusherChannel('permissions-updates', 'update', { data: formattedResponse })
