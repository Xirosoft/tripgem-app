<script>
import FormValidation from '@formvalidation/core'
import AutoFocus from '@formvalidation/plugin-auto-focus'
import Bootstrap5 from '@formvalidation/plugin-bootstrap5'
import SubmitButton from '@formvalidation/plugin-submit-button'
import Trigger from '@formvalidation/plugin-trigger'
