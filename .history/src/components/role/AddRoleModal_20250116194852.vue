  ...
  setup() {
    ...
    const onSubmit = handleSubmit(async (values, { resetForm }) => {
      ...
      try {
        ...
        rolesListStore.message = 'Role created successfully'
        rolesListStore.messageType = 'success'
        resetForm()
      } catch (error) {
        console.error(error)
        rolesListStore.message = 'Failed to create role'
        rolesListStore.messageType = 'danger'
      } finally {
        rolesListStore.loading = false
      }
    })
    ...
    return {
      ...
      parentRole,
      onSubmit,
      loading: rolesListStore.loading,
      message: rolesListStore.message,
      messageType: rolesListStore.messageType,
    }
  },
  mounted() {
