  ...
  computed: {
    filteredMenuItems() {
      ...
      const filteredItems = this.menuItems.filter((item) => {
        ...
        // console.log('okay', this.uCan('read', 'user_dashboard'))
  ...
  methods: {
    ...
    filteredSubmenuItems(submenu) {
      ...
      const filteredSubItems = submenu.filter((subitem) => {
        const canAccess = this.uCan(subitem.permission.module, subitem.permission.action)
        console.log('okay', this.uCan('write', 'merchant_module'))
        console.log(
          `Subitem: ${subitem.title}, Module: ${subitem.permission.module} Can Access: ${subitem.permission.module}`,
        )
        return canAccess
      })
